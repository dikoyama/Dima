...
namespace Dima.Api.Handlers
{
    public class TransactionHandler(AppDbContext context) : ITransactionHandler
    {
        public async Task<Response<Transaction?>> CreateAsync(CreateTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, code: 500, "Não foi possível criar sua transação");
            }
        }
        ...
        public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, code: 500, "Não foi possível atualizar sua transação");
            }
        }
        ...
        public async Task<Response<Transaction?>> DeleteAsync(DeleteTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, code: 500, "Não foi possível excluir sua transação");
            }
        }
        ...
        public async Task<Response<Transaction?>> GetByIdAsync(GetTransactionByIdRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, code: 500, "Não foi possível recuperar sua transação");
            }
        }
        ...
        public async Task<PagedResponse<List<Transaction>?>> GetByPeriodAsync(GetTransactionByPeriodRequest request)
        {
            ...
            {
                return new PagedResponse<List<Transaction>?>(null, code: 500, "Não foi possível determinar a data de início ou fim");
            }
